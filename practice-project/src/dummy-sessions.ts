...
export const SESSIONS = [
	...
	{
		id: 'sess11',
		title: 'Navigating React Router for SPA',
		summary: 'Master single-page application navigation.',
		description:
			"Dive into the world of single-page applications (SPA) with React Router. Learn how to create dynamic routing in your React applications for seamless navigation without page refreshes. We'll cover the basics of React Router, dynamic routing, and how to handle nested routes. By the end of the session, you'll understand how to implement complex navigation patterns in your SPA with confidence.",
		duration: 1.5,
		date: '2023-11-29',
		image: blueprintComponent
	},
	{
		id: 'sess12',
		title: 'Building Real-time Applications with React',
		summary: 'Bring your applications to life with real-time updates.',
		description:
			"Unlock the potential of real-time applications using React. This session will guide you through the process of integrating WebSocket or Firebase for real-time data syncing in your applications. We'll discuss the importance of real-time updates, explore different approaches for achieving them, and implement a sample real-time feature. Prepare to elevate your user experience by making your applications more dynamic and interactive.",
		duration: 2,
		date: '2023-12-01',
		image: dataFetching
	}
